...
namespace TubeStarMetro
{
    public enum CommentStrings
    {
        ...
        [Comment]
        [Description("How'd I end up watching this?")]
        DislikeComment6,
        ...
        [Comment]
        [Description("I'm glad I know the truth")]
        ...
        [Comment]
        [Description("When's it coming out?")]
        GamingComment1,

        [Comment]
        [Description("How long have you played this game?")]
        GamingComment2,
        ...
        [Comment]
        [Description("Yeah... I'll just pirate this.")]
        GamingComment5,
        ...
        [Comment]
        [Description("The graphics are old")]
        GamingComment10,
        ...
        [Comment]
        [Description("But, does it run in 1080p?")]
        GamingComment12,
        ...
        [Comment]
        [Description("My friends introduced me to this show")]
        AnimeComment9,

        [Comment]
        [Description("Most boring﻿ show ever")]
        AnimeComment10,
        ...
        [Comment]
        [Description("Looking for more? Visit my channel!")]
        RandomComment1,
        ...
        [Comment]
        [Description("Thumbs up if you're a bot")]
        RandomComment6,
        ...
        [Comment]
        [Description("Hypnotic! I'd sell my soul if this video told me to!")]
        HypnoticComment2,
        ...
        [Comment]
        [Description("My mind isn't used to stuff this bad! Sharing!")]
        SoBadComment2,

        [Comment]
        [Description("I'm sharing this awful video!")]
        SoBadComment3,
        ...
        [Comment]
        [Description("Unsubbed! This is awful!")]
        UnsubscribeQualityComment1,

        [Comment]
        [Description("Don't want to see this stuff again! Unsubbed!")]
        ...
        [Comment]
        [Description("Well I won't see this on my start page anymore!")]
